...
class _HomePageState extends State<HomePage> {
  ...
  Widget _criarBody() => Padding(
    ...
    child: Column(
      ...
      children: [
        ...
        const SizedBox(height: 10), // Espaçamento entre os botões
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceEvenly, // Alinha os botões ao centro
          children: [
            ElevatedButton(
              onPressed: _monitorandoLocalizacao ? _pararMonitoramento : _monitorarLocalizacao,
              child: Text(_monitorandoLocalizacao ? 'Parar monitoramento' : 'Monitorar localização'),
            ),
            ElevatedButton(
  ...
  void _monitorarLocalizacao() {
    ...
    _subscription = Geolocator.getPositionStream(
      ...
      if (_ultimaLocalizacaoObtida != null) {
        ...
        _linhas.add('Distância percorrida: ${_distanciaPercorrida.toInt()} m');
      }
  ...
  Future<bool> _servicoHabilitado() async {
    ...
    if (!servicoHabilitado) {
      await _mostrarDialogMensagem(
        'Para utilizar esse serviço, você deverá habilitar o serviço de '
